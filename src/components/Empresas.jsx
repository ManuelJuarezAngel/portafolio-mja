            ...
            <div className="my-10 max-w-7xl text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-5">
                    <div className="rounded bg-white/10 backdrop-blur-md border border-white/30 shadow-lg flex justify-center items-center">
                        <img src="src/assets/KFC-logo.png" className="max-w-50" alt="marca" />
                    </div>
                    <div className="rounded bg-white/10 backdrop-blur-md border border-white/30 shadow-lg flex justify-center items-center">
                        <img src="src/assets/kk.png" className="max-w-50" alt="marca" />
                    </div>
                    <div className="rounded bg-white/10 backdrop-blur-md border border-white/30 shadow-lg flex justify-center items-center">
                        <img src="src/assets/alsea.png" className="max-w-50" alt="marca" />
                    </div>
                    <div className="rounded bg-white/10 backdrop-blur-md border border-white/30 shadow-lg flex justify-center items-center">
                        <img src="src/assets/vdc.png" className="max-w-50" alt="marca" />
                    </div>
                    <div className="rounded bg-white/10 backdrop-blur-md border border-white/30 shadow-lg flex justify-center items-center">
                        <img src="src/assets/unilever.png" className="max-w-50" alt="marca" />
                    </div>
                </div>
            </div>
        </div>
