            ...
            <div className="max-w-7xl flex justify-center items-center gap-4 flex-col sm:flex-col lg:flex-row-reverse z-20 my-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 w-full lg:w-[70%] place-items-center">
                    <div className="h-100 w-88 md:w-50 rounded shadow-lg cursor-pointer">
                        <a href="">
                            <img src="/img/ball.webp" className="h-full w-full object-cover" alt="img" />
                        </a>
                    </div>
                    <div className="h-100 w-88 md:w-50 rounded shadow-lg cursor-pointer">
                        <a href="">
                            <img src="/img/cazuelas1.webp" className="h-full w-full object-cover" alt="img" />
                        </a>
                    </div>
                    <div className="h-100 w-88 md:w-50 rounded shadow-lg cursor-pointer">
                        <a href="">
                            <img src="/img/invitacion.png" className="h-full w-full object-cover" alt="img" />
                        </a>
                    </div>
                    <div className="h-100 w-88 md:w-50 rounded shadow-lg cursor-pointer">
                        <a href="">
                            <img src="/img/ruthless.png" className="h-full w-full object-cover" alt="img" />
                        </a>
                    </div>
                </div>
            </div>
